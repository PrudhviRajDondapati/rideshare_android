...
public class AboutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View aboutPage = new AboutPage(this)
                .isRTL(false)
                .setDescription(" This mobile app is developed by the Conestoga Students Harish ,Prudhvi and siva under the guidance of Professor. Zaman.")
    ...
    private Element createCopyright()
    {
        ...
        @SuppressLint("DefaultLocale") final String copyrightString = String.format("Copyright %d by RideShare", Calendar.getInstance().get(Calendar.YEAR));
